/*
  ...
  - You are about to drop the column `deliveryFeed` on the `Restaurant` table. All the data in the column will be lost.
...
*/
-- AlterTable
ALTER TABLE "Restaurant" DROP COLUMN "deliveryFeed",
